...
RegisterNetEvent("consumables:client:shkembe", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"shkembe"})
    action = true
    QBCore.Functions.Progressbar("eat_something", "Баси вкусното шкембе..", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
