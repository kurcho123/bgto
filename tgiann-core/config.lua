...
config = {
    ...
    oxlib = {
        notifLocation = 'top-left', -- 'top' or 'top-right' or 'top-left' or 'bottom' or 'bottom-right' or 'bottom-left' (ox notifs will not work if you are using qb or esx)
    },
    policeJobs = {
        "police",
    },
...
frameworkConfig = {
    ...
    qsInventoryScriptName = "lj-inventory",
