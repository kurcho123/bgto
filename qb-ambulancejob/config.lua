...
Config.Locations = {
    ...
    ["beds"] = {
        [1] = {coords = vector4(308.13, -582.89, 44.53, 335.65), taken = false, model = 1631638868},
        [2] = {coords = vector4(310.96, -579.05, 44.53, 164.5), taken = false, model = 1631638868},
        [3] = {coords = vector4(311.58, -584.09, 44.53, 335.65), taken = false, model = 1631638868},
        [4] = {coords = vector4(313.74, -585.29, 44.53, 335.65), taken = false, model = 1631638868},
        [5] = {coords = vector4(315.47, -581.04, 44.53, 164.5), taken = false, model = 1631638868},
        [6] = {coords = vector4(362.43, -581.54, 44.28, 66.5), taken = false, model = 1631638868},
        [7] = {coords = vector4(361.93, -585.86, 44.28, 67.5), taken = false, model = 1631638868},
        [8] = {coords = vector4(361.72, -587.81, 43.29, 68.46), taken = false, model = 1631638868},
	--- paleto
	    [9] = {coords = vector4(-252.43, 6312.25, 33.34, 313.48), taken = false, model = 2117668672},
        [10] = {coords = vector4(-247.04, 6317.95, 33.34, 134.64), taken = false, model = 2117668672},
        [11] = {coords = vector4(-255.98, 6315.67, 33.34, 313.91), taken = false, model = 2117668672},
    },
    ["stations"] = {
