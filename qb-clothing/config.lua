...
Config.ClothingRooms = {
	...
	[9] = {requiredJob = "police", coords = vector3(1841.08, 3679.45, 34.19), cameraLocation = vector4(1841.08, 3679.45, 34.19, 69.18)},
}
        ...
        ["male"] = { -- Gender
			[1] = {
				...
				outfitData = {
					...
					["t-shirt"]     = { item = 15, texture = 0 },  -- T-Shirt
					["torso2"]      = { item = 326, texture = 6 },  -- Jackets
					["vest"]        = { item = 0,   texture = 0 },  -- Vest
					["decals"]      = { item = 0,  texture = 0 },  -- Decals
					["accessory"]   = { item = 135, texture = 0 },  -- Neck
					["bag"]         = { item = 0,   texture = 0 },  -- Bag
					["pants"]       = { item = 101,  texture = 0 },  -- Pants
					["shoes"]       = { item = 107,  texture = 1 },  -- Shoes
					["mask"]        = { item = 43, texture = 0 },  -- Mask
					["hat"]         = { item = 0, texture = 0 },  -- Hat
					["glass"]       = { item = 0,   texture = 0 },  -- Glasses
