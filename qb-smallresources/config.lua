...
Config.Teleports = {
	...
	[20] = {
        [1] = {
            coords = vector4 (974.56, 12.74, 81.04, 27.66),
            ["AllowVehicle"] = false,
            drawText = '[E] Влез'
        },
        [2] = {
            coords = vector4(985.93, 60.92, 111.28, 298.48),
            ["AllowVehicle"] = false,
            drawText = '[E] Излез'
        },
    },
	[21] = {
        [1] = {
            coords = vector4 (981.97, 56.48, 111.28, 27.66),
            ["AllowVehicle"] = false,
            drawText = '[E] Влез'
        },
        [2] = {
            coords = vector4(980.57, 56.66, 116.16, 298.48),
            ["AllowVehicle"] = false,
            drawText = '[E] Излез'
        },
    },
	[22] = {
        [1] = {
            coords = vector4 (-784.66, 323.85, 212.0, 27.66),
            ["AllowVehicle"] = false,
            drawText = '[E] Влез'
        },
        [2] = {
            coords = vector4(-794.16, 352.03, 88.0, 298.48),
            ["AllowVehicle"] = false,
            drawText = '[E] Излез'
        },
    },
	...
	[24] = {
        [1] = {
            coords = vector4(2142.64, 2905.71, 50.77, 326.47),
            ["AllowVehicle"] = false,
            drawText = '[E] Влез'
        },
        [2] = {
            coords = vector4(2154.76, 2921.02, -81.08, 272.54),
            ["AllowVehicle"] = false,
            drawText = '[E] Излез'
        },
    },
	[25] = {
        [1] = {
            coords = vector4(-635.73, 44.19, 42.7, 83.86),
            ["AllowVehicle"] = false,
            drawText = '[E] Влез'
        },
        [2] = {
            coords = vector4(-603.46, 58.96, 98.2, 87.46),
            ["AllowVehicle"] = false,
            drawText = '[E] Излез'
        },
    },
	[26] = {
        [1] = {
            coords = vector4(-1129.14, -2838.85, 13.96, 146.5),
            ["AllowVehicle"] = true,
            drawText = '[E] Влез в Галактиката'
        },
        [2] = {
            coords = vector4(-1639.21, -2989.69, -77.34, 264.77),
            ["AllowVehicle"] = true,
            drawText = '[E] Излез от Галактиката'
        },
    },
	[27] = {
        [1] = {
            coords = vector4(318.03, -1476.4, 29.97, 235.39),
            ["AllowVehicle"] = false,
            drawText = '[E] Влез в Моргата'
        },
        [2] = {
            coords = vector4(279.63, -1349.32, 24.54, 321.52),
            ["AllowVehicle"] = false,
            drawText = '[E] Излез от Моргата'
        },
    },
}
