...
local function ItemsToItemInfo()
	itemInfos = {
		[1] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 32x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 32x."},
		[2] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 50x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 62x."},
		[3] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 80x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 45x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 68x."},
		[4] = {costs = QBCore.Shared.Items["electronickit"]["label"] .. ": 5x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 112x, "..QBCore.Shared.Items["steel"]["label"] .. ": 80x."},
		[5] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 10x, " ..QBCore.Shared.Items["plastic"]["label"] .. ": 10x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 10x, "..QBCore.Shared.Items["iron"]["label"] .. ": 7x, "..QBCore.Shared.Items["cryptostick"]["label"] .. ": 20x."},
		[6] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 196x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 74x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 68x."},
		[7] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 132x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 43x, "..QBCore.Shared.Items["plastic"]["label"] .. ": 61x."},
		[8] = {costs = QBCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 30x, "..QBCore.Shared.Items["copper"]["label"] .. ": 26x."},
		[9] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 60x, " ..QBCore.Shared.Items["glass"]["label"] .. ": 130x."},
		[10] = {costs = QBCore.Shared.Items["aluminum"]["label"] .. ": 160x, " ..QBCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[11] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 93x, " ..QBCore.Shared.Items["steel"]["label"] .. ": 94x, "..QBCore.Shared.Items["plastic"]["label"] .. ": 95x, "..QBCore.Shared.Items["aluminum"]["label"] .. ": 96x."},
		[12] = {costs = QBCore.Shared.Items["iron"]["label"] .. ": 400x, " ..QBCore.Shared.Items["rubber"]["label"] .. ": 300x, "..QBCore.Shared.Items["screwdriverset"]["label"] .. ": 30x, "..QBCore.Shared.Items["advancedlockpick"]["label"] .. ": 9x."},
	}
	...
	while true do
		...
		if craftObject ~= 0 then
			...
			if #(pos - objectPos) < 1.5 then
				...
				DrawText3Ds(objectPos.x, objectPos.y, objectPos.z + 1.0, "~g~E~w~ - Крафтване на предмети")
